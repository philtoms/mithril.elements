//Mithril.Element type definitions for Typescript
...
interface MithrilStatic {
	...
	(selector: string, attributes: Object, children: any, state: any): MithrilStatefullVirtualElement; 
	...
	element(name: string, module: MithrilModule): Object;
	template(selector: string, attributes: Object, children?: any): MithrilVirtualElement;
...
interface MithrilStatefullVirtualElement {
	tag: string;
	attrs: Object;
	children: any;
	state: any;
